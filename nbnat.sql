...
=======
-- 產生日期: 2013 年 07 月 15 日 07:27
>>>>>>> remotes/main/scale-canvas-test
-- 伺服器版本: 5.5.24-log
-- PHP 版本: 5.4.3
...
(76, '[{"topicId":"125","ans":["x"]},{"topicId":"126","ans":["+","x"]},{"topicId":"127","ans":["161"]}]', 'true', 15, '2013-07-15 03:56:42', 'c624a7ea37b73a7ad1d413d8a8a0fa6a', 1);
>>>>>>> remotes/main/scale-canvas-test
...
(127, '下列何者選項答案不為10?', 'choose', '', '[]', 4000, 'true', 'c624a7ea37b73a7ad1d413d8a8a0fa6a');
...
--
ALTER TABLE `news`
  ADD CONSTRAINT `fk_News_Category` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_News_Member` FOREIGN KEY (`author_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
