tinymce.PluginManager.add("media", function(e, t) {
	...
	function i() {
		function t(e) {
			var t, o, a, r;
			t = n.find("#width")[0], o = n.find("#height")[0], a = t.value(), r = o.value(), n.find("#constrain")[0].checked() && i && s && a && r && (e.control == t ? ( r = Math.round(a / i * r), o.value(r)) : ( a = Math.round(r / s * a), t.value(a))), i = a, s = r
		}
		...
		c = l(e.selection.getNode()), i = c.width, s = c.height, n = e.windowManager.open({
			...
			body : [{
				...
				type : "form",
				onShowTab : function() {
					this.fromJSON(r(this.next().find("#embed").value()))
				},
				items : [{
					name : "source1",
					type : "filepicker",
			...
			, {
				...
				spacing : 10,
				onShowTab : function() {
					this.find("#embed").value(a(this.parent().toJSON()))
				},
				items : [{
					type : "label",
	...
	function o() {
		...
		return t.getAttribute("data-mce-object") ? e.selection.getContent() :
		void 0
	}

	function a(i) {
		var o = "";
		return i.source1 || (tinymce.extend(i, r(i.embed)), i.source1) ? (i.source1 = e.convertURL(i.source1, "source"), i.source2 = e.convertURL(i.source2, "source"), i.source1mime = n(i.source1), i.source2mime = n(i.source2), i.poster = e.convertURL(i.poster, "poster"), i.flashPlayerUrl = e.convertURL(t + "/moxieplayer.swf", "movie"), i.embed ? o = s(i.embed, i, !0) : (tinymce.each(c, function(e) {
			var t, n, o;
			if ( t = e.regex.exec(i.source1)) {
				for ( o = e.url, n = 0; t[n]; n++)
					o = o.replace("$" + n, function() {
						return t[n]
					});
				i.source1 = o, i.type = e.type, i.width = e.w, i.height = e.h
			}
		}), i.width = i.width || 300, i.height = i.height || 150, tinymce.each(i, function(t, n) {
			i[n] = e.dom.encode(t)
		}), "iframe" == i.type ? o += '<iframe src="' + i.source1 + '" width="' + i.width + '" height="' + i.height + '"></iframe>' : -1 != i.source1mime.indexOf("audio") ? e.settings.audio_template_callback ? o = e.settings.audio_template_callback(i) : o += '<audio controls="controls" src="' + i.source1 + '">' + (i.source2 ? '\n<source src="' + i.source2 + '"' + (i.source2mime ? ' type="' + i.source2mime + '"' : "") + " />\n" : "") + "</audio>" : o = e.settings.video_template_callback ? e.settings.video_template_callback(i) : '<video width="' + i.width + '" height="' + i.height + '"' + (i.poster ? ' poster="' + i.poster + '"' : "") + ' controls="controls">\n' + '<source src="' + i.source1 + '"' + (i.source1mime ? ' type="' + i.source1mime + '"' : "") + " />\n" + (i.source2 ? '<source src="' + i.source2 + '"' + (i.source2mime ? ' type="' + i.source2mime + '"' : "") + " />\n" : "") + "</video>"), o) : ""
	}
	...
	function l(t) {
		return t.getAttribute("data-mce-object") ? r(e.serializer.serialize(t, {
			selection : !0
		})) : {}
	}
	...
	function s(e, t, n) {
		function i(e, t) {
			...
			if ( o = "" + t[n], e.map[n])
				for ( i = e.length; i--; )
					a = e[i], a.name == n && ( o ? (e.map[n] = o, a.value = o) : (
					delete e.map[n], e.splice(i, 1)));
			else
				o && (e.push({
					name : n,
					value : o
		...
		var o = new tinymce.html.Writer, a = 0;
		return new tinymce.html.SaxParser({
			validate : !1,
			special : "script,noscript",
			comment : function(e) {
		...
		}, new tinymce.html.Schema({})).parse(e), o.getContent()
	}
	...
	e.on("ResolveName", function(e) {
		...
		tinymce.each("webkitallowfullscreen mozallowfullscreen allowfullscreen".split(" "), function(e) {
			...
			for (var i, o, a, r, l, s, c, d = t.length; d--; ) {
				for ( o = t[d], a = new tinymce.html.Node("img", 1), a.shortEnded = !0, s = o.attributes, i = s.length; i--; )
					r = s[i].name, l = s[i].value, "width" !== r && "height" !== r && "style" !== r && (("data" == r || "src" == r) && ( l = e.convertURL(l, r)), a.attr("data-mce-p-" + r, l));
				c = o.firstChild && o.firstChild.value, c && (a.attr("data-mce-html", escape(c)), a.firstChild = null), a.attr({
					width : o.attr("width") || "300",
					height : o.attr("height") || ("audio" == n ? "30" : "150"),
					style : o.attr("style"),
			...
			for (var n, i, o, a, r, l, s = e.length; s--; ) {
				for ( n = e[s], i = new tinymce.html.Node(n.attr(t), 1), "audio" != n.attr(t) && i.attr({
					width : n.attr("width"),
					height : n.attr("height")
				}), i.attr({
					style : n.attr("style")
				}), a = n.attributes, o = a.length; o--; ) {
					var c = a[o].name;
					0 === c.indexOf("data-mce-p-") && i.attr(c.substr(11), a[o].value)
				}
				r = n.attr("data-mce-html"), r && ( l = new tinymce.html.Node("#text", 3), l.raw = !0, l.value = unescape(r), i.append(l)), n.replace(i)
			}
		})
		...
		var t, n = e.target;
		n.getAttribute("data-mce-object") && ( t = n.getAttribute("data-mce-html"), t && ( t = unescape(t), n.setAttribute("data-mce-html", escape(s(t, {
			width : e.width,
			height : e.height
		})))))
	}), e.addButton("media", {
