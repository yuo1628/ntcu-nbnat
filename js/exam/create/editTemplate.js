...
function importTemplate(_id) {
	...
	$.post(_href + "/editQuizTemplate", {
		...
		$("div#div-" + _id + " div div.editTemplate .useTinymce").bind("click", function() {
			...
			$.post("./index.php/mExam/showTinymce", {
				content : _oldCon,
				type : $("div#div-" + _id + " div div.editTemplate div.quizType").html()
...
function updateQuiz(_id) {
	...
	var _type = $("div#div-" + _id + " div div.editTemplate div.quizType").html();
	...
	{			
		...
		$.post(_href + "/editQuiz", {
			...
			$("div#div-" + _id + " div.topic").html(_conBox).show();
