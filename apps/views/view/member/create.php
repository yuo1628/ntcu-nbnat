<div id="member">
	...
	<table>
		...
		<tr>
			<th>再次輸入密碼</th><td>
			<input type="password" id="secondPwd" />
			<span id="checkPwd" class="emptyPwd" title="兩次密碼不相等"></span></td>
		</tr>
		<tr>
			<th>權限</th><td><select id="rank"></select></td>
		</tr>
		<tr>
		...
		-->
		<tr>
			<th colspan="2">所屬單位</th>
		</tr>
		<tr>
			<th>縣市</th><td id="city" level="0">
		...
		<tr>
			<th>學校類型</th><td id="schoolType" level="2">
		...
		<tr>
			<th>學校名稱</th><td id="schoolName" level="3"></td>
		</tr>
		<tr>
			<th>學校地址</th>
			<td id='schoolAddress' level='4'>
			<input type='text' id='schoolAddressText' />
			</td>
		</tr>
		<tr>
			<th>學校電話</th>
			<td id='schoolPhone' level='5'>
			<input type='text' id='schoolPhoneText' />
			</td>
		</tr>
		<tr unit="0">
			<th>服務單位</th>
			...
			<ul id="unitChoose">
				<li>
					<input type="checkbox" class="unitCheck" value="0">
					無
				</li>
				<li>
					<input type="checkbox" class="unitCheck" value="1">
					處室
				</li>
				<li>
					<input type="checkbox" class="unitCheck" value="2">
					班級
				</li>
			</ul></td>
		</tr>
		<tr unit="1">
			<th>處室</th><td id="unitType" level='6'>
			<input type='text' id='unitTypeText'/>
			</td>
		</tr>
		<tr unit="2">
			<th>學制</th><td id="classType" level='6'>
			<input type='text' id='classTypeText'/>
			</td>
		</tr>
		<tr unit="2">
			<th>年級</th><td id="classGrade" level='7'>
			<input type='text' id='classGradeText'/>
			</td>
		</tr>
		<tr unit="2">
			<th>班別</th><td id="className" level='8'>
